...
@section('title', 'Ngaji Absensi | Data Kelas')
@section('content')
            ...
            <form action="/kelas/" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <!--<div class="col-lg-6">
                            <div class="form-group">
                                <label for="jurusan">Bidang studi</label>
                                <select class="form-control" id="jurusan" name="jurusan">
                                    <option selected disabled>-Pilih Bidang studi keagamaan-</option>
                                    <option>Tahfidz Quran</option>
                                    <option>Hadis</option>
                                    <option>Aqidah</option>
                                    <option>Ilmu Bahasa Arab</option>
                                    <option>Sejarah Islam</option>
                                </select>
                            </div>
                        </div>-->
                    </div>
