...
@section('title', 'Ngaji Absensi | Data Siswa')
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">Daftar Santri</div>
                                    ...
                                    @foreach($resource as $index => $res)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($res->jenis_kelamin=="L"){{ "Laki-Laki" }}@else{{ "Perempuan" }}@endif
                                            </td>
                                            <td class="text-center">
                                                <p data-placement="top" data-toggle="tooltip" title="Edit"><button
                                                        data-aksi="siswa" data-nama="{{ $res->nama }}"
                                                        data-id="{{ $res->id_siswa }}"
                                                        data-status="{{ $res->status }}"
                                                        data-jk="{{ $res->jenis_kelamin }}"
                                                        data-tk="{{ $res->tingkat_kelas }}"
                                                        data-nis="{{ $res->nis }}"
                                                        class="edit-button btn btn-primary btn-xs" data-title="Edit"
                                            ...
                                            <td class="text-center">
                                                <p data-placement="top" data-toggle="tooltip" title="Delete"><button
                                                        data-aksi="siswa" data-id="{{ $res->id_siswa }}"
                                                        class="delete-button btn btn-danger btn-xs" data-title="Delete"
            ...
            <div class="col-sm-12">
                <p class="back-link">&copy; <?php echo date('Y') ?> Alfauzi</p>
            </div>
        </div>
        <!--/.row-->
    </div>
            ...
            <form action="/siswa/" method="post">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="siswa">Nama Santri</label>
        ...
        <div class="modal-content">
            <form id="delete-form" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Yakin ingin
...
<script>
    ...
    $('input[name="search"]').keyup(fetchSiswaData);
    $('.search').change(fetchSiswaData);
    $('#sort').change(fetchSiswaData);
    $('#order').change(fetchSiswaData);
</script>
@endsection