...
@section('title', 'Ngaji Absensi | Dashboard')
@section('content')
    ...
    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-xs-10 col-md-10">
                                    <h4><a href="#">Absensi Kelas XII</a></h4>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">Absensi <span class="pull-right">Kelas XII / 10 Oktober 2017</span></div>
                <div class="panel-body">
